...
//        componentParamMap = new  HashMap<String,Integer>();
    ...
    public void invoke(DataEvent value, Context context) throws Exception {
        ...
        int dtype = componentParamMap.get(String.valueOf(value.getComponentType())+String.valueOf(value.getComponentId()));
//        int dtype =getDtype(value.getComponentType(),value.getComponentParamId());
    ...
    public Map<String,Integer> getDtype() throws SQLException {
        ...
        JdbcTemplate jdbcTemplateMs = new JdbcTemplate(dataSourceMs);
        try {
